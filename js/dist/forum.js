...
/***/ "./node_modules/sceditor/minified/plugins/undo.js":
/*!********************************************************!*\
  !*** ./node_modules/sceditor/minified/plugins/undo.js ***!
  \********************************************************/
/***/ (() => {
...
!function () {
  ...
  sceditor.plugins.undo = function () {
    var n,
      ...
      g = 0;
    function f(e) {
      if (d = !0, i.sourceMode(e.sourceMode), e.sourceMode) i.val(e.value, !1), i.sourceEditorCaret(e.caret);else if (i.getBody().innerHTML = e.value, e.caret) {
        var t = i.getRangeHelper().selectedRange(),
          n = t,
          e = e.caret;
        try {
          var o = e.startPositions,
            r = e.endPositions;
          n.setStart(S(a, o), o[0]), n.setEnd(S(a, r), r[0]);
        } catch (e) {
    ...
    function p(e, t) {
      ...
      e[t] = function () {
        var e = u;
        !e && !d && o && i.getRangeHelper().hasSelection() && h(), u = !0, n.apply(this, arguments), e || (u = !1, d || (v(), s = ""));
      };
    }
    function v() {
      g && (t.length -= g, g = 0), 0 < e && t.length > e && t.shift(), o = {}, h(), t.push(o);
    }
    function h() {
      var e = i.sourceMode();
      o.caret = e ? i.sourceEditorCaret() : function (e) {
        if (e) return a.normalize(), {
          startPositions: y(e.startContainer, e.startOffset),
          endPositions: y(e.endContainer, e.endOffset)
        };
      }(i.getRangeHelper().selectedRange()), o.sourceMode = e, o.value = e ? i.getSourceEditorValue(!1) : i.getBody().innerHTML;
    }
    function E() {
    ...
    r.init = function () {
      e = (i = this).undoLimit || e, i.addShortcut("ctrl+z", r.undo), i.addShortcut("ctrl+shift+z", r.redo), i.addShortcut("ctrl+y", r.redo);
    }, r.signalReady = function () {
      function e(e) {
        "historyUndo" === e.inputType ? (r.undo(), e.preventDefault()) : "historyRedo" === e.inputType && (r.redo(), e.preventDefault());
      }
      function t() {
        s = "", v();
      }
      n = i.getContentAreaContainer().nextSibling, a = i.getBody(), v(), p(i, "setWysiwygEditorValue"), p(i, "setSourceEditorValue"), p(i, "sourceEditorInsertText"), p(i.getRangeHelper(), "insertNode"), p(i, "toggleSourceMode"), a.addEventListener("beforeinput", e), n.addEventListener("beforeinput", e), a.addEventListener("compositionend", t), n.addEventListener("compositionend", t), document.addEventListener("selectionchange", E);
    }, r.destroy = function () {
      ...
      if (l = !0, t && !e.isComposing) switch (e.inputType) {
        case "deleteContentBackward":
          o && s === t && c < 20 ? h() : (v(), c = 0), s = t;
          break;
        case "insertText":
          c += e.data ? e.data.length : 1, o && s === t && c < 20 && !/\s$/.test(e.data) ? h() : (v(), c = 0), s = t;
          break;
        default:
          s = "sce-misc", c = 0, v();
      }
...
var IfContext = /*#__PURE__*/function () {
  function IfContext() {
    ...
    this.templatePatternBefore = [];
    this.templatePatternAfter = [];
  }
  var _proto = IfContext.prototype;
  _proto.content = function content(_content) {
    if (this.beforeTemplate) {
      this.templatePatternBefore.push(_content);
    } else {
      this.templatePatternAfter.push(_content);
    }
  };
  _proto.pattern = function pattern() {
    return "^" + this.templatePatternBefore.map(function (s) {
      return s.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    }).join("\\s*?") + "([^]*)" + this.templatePatternAfter.map(function (s) {
      return s.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    }).join("\\s*?");
  };
  _proto.merge = function merge(newContext) {
    ...
    if (this.beforeTemplate) {
      newContext.templatePatternBefore.forEach(function (t) {
        return _this.templatePatternBefore.push(t);
      });
      if (!newContext.beforeTemplate) {
        newContext.templatePatternAfter.forEach(function (t) {
          return _this.templatePatternAfter.push(t);
        });
...
/* harmony import */ var sceditor_minified_plugins_undo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! sceditor/minified/plugins/undo */ "./node_modules/sceditor/minified/plugins/undo.js");
/* harmony import */ var sceditor_minified_plugins_undo__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(sceditor_minified_plugins_undo__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var textarea_caret__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! textarea-caret */ "./node_modules/textarea-caret/index.js");
/* harmony import */ var textarea_caret__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(textarea_caret__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _getTemplates__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./getTemplates */ "./src/forum/getTemplates.ts");
/* harmony import */ var _util_textareaStyler__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./util/textareaStyler */ "./src/forum/util/textareaStyler.ts");
/* harmony import */ var _util_bbcodeFormatUtil__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./util/bbcodeFormatUtil */ "./src/forum/util/bbcodeFormatUtil.ts");
/* harmony import */ var _util_shortcutHandleUtil__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./util/shortcutHandleUtil */ "./src/forum/util/shortcutHandleUtil.ts");
...
/* harmony import */ var _plugin_hookEditorPlugin__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./plugin/hookEditorPlugin */ "./src/forum/plugin/hookEditorPlugin.ts");
...
function applyEditor() {
  sceditor.plugins.hooks = _plugin_hookEditorPlugin__WEBPACK_IMPORTED_MODULE_8__["default"];
  var instance = null;
...
/***/ "./src/forum/plugin/hookEditorPlugin.ts":
/*!**********************************************!*\
  !*** ./src/forum/plugin/hookEditorPlugin.ts ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ hookEditorPlugin)
/* harmony export */ });
/* harmony import */ var flarum_common_extend__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! flarum/common/extend */ "flarum/common/extend");
/* harmony import */ var flarum_common_extend__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(flarum_common_extend__WEBPACK_IMPORTED_MODULE_0__);

function hookEditorPlugin() {
  var instance;
  var thisObj = this;
  this.init = function () {
    instance = this;
    instance._keys = {};
    (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_0__.extend)(instance, "addShortcut", function (a, b, c) {
      instance._keys[b] = c;
    });
  };
...
/***/ "./src/forum/util/shortcutHandleUtil.ts":
/*!**********************************************!*\
  !*** ./src/forum/util/shortcutHandleUtil.ts ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   handleShortcuts: () => (/* binding */ handleShortcuts)
/* harmony export */ });
var Shortcuts = {
  bold: {
    shortcut: 'Ctrl+B',
...
function handleShortcuts(editor) {
